...
public class ParallelFunctions {
	public static <X,Y> Function<X,Bi<Y>> make(Function<X,Y> f0, Function<X,Y> f1){
		return new ParallelFunctions2<>(f0, f1);
	}
	public static <X,Y> Function<X,Bi<Y>> make(Function<X,Y> f0, Function<X,Y> f1, boolean swap){
		return swap ? new ParallelFunctions2<>(f1, f0) : new ParallelFunctions2<>(f0, f1);
	}
	public static <X,Y> Function<X,Bi<Y>> make(Bi<Function<X,Y>> functions){
